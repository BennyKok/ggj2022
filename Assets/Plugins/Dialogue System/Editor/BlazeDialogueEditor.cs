...
namespace Blaze.Dialogue.Editor
{
    ...
    public class BlazeDialogueEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("invokeOnce"));
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("appendActorName"));
        ...
        public void AddNewItem(bool insert)
        {
            ...
            var line = contentsProp.GetArrayElementAtIndex(index);
            var array = line.FindPropertyRelative("content").FindPropertyRelative("contents");
            array.ClearArray();
            array.arraySize = BlazeDialogueSettingsEditor.GetOrCreateSettings().languageDefinition.Length;

            line.FindPropertyRelative("chance").floatValue = 1;
            line.FindPropertyRelative("delay").floatValue = 2;
